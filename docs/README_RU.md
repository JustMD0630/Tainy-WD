[English](README.md) | [Hindi (India)](README_hi.md) | [Português (Brasil)](README_pt-BR.md) | [Tiếng Việt](README_VI.md) | [ภาษาไทย](README_TH.md) | **Русский**
...
<p align="center">
  ...
  <p align="center">Универсальный и мощный музыкальный бот для Discord, который привнесет ритм и мелодию на ваш сервер!
    ...
    ·
    <a href="https://github.com/RainyXeon/Tainy/issues">Сообщить о проблемах и внести предложения</a>
    ·
...
1. Клонируйте этот репозиторий, используя `git clone https://github.com/RainyXeon/Tainy.git`
2. Запустите `cd Tainy` идти в **tainy** папка .
3. Конфиг файлы:
...
8. **Наслаждайтесь прослушиванием музыки с tainy!**
...
1. [Нажми на меня](https://replit.com/@RainyXeon/Tainy) и разветвить ответ.
2. заполните **app.yml** `TOKEN` и `NODES`
3. Запустите бота с помощью кнопки **Запустить**.
4. **Наслаждайтесь прослушиванием музыки с tainy!**

## ⚙️ Гайд

Для расширенного руководства по установке и настройке посетите вкладку **Wiki** или [Нажми сюда!](https://github.com/RainyXeon/Tainy/wiki)

## 📜 Политика управления версиями

tainy следует [Семантическое версионирование](https://semver.org/)
...
Номера версий могут иметь различные комбинации в зависимости от типа выпуска:

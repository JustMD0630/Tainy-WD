...
const tainy = new Manager(configData, configData.utilities.MESSAGE_CONTENT.enable)
// Anti crash handling
process
  ...
  .on('exit', () => tainy.logger.info('ClientManager', `Successfully Powered Off tainy, Good Bye!`))
  .on('SIGINT', () => {

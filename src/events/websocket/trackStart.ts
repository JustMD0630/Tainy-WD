...
export default class {
  async execute(client: Manager, player: RainlinkPlayer) {
    ...
    // if (ws) {
    //   client.logger.info('WSTrackStart', `[DEBUG] Sending track start to guild: ${player.guildId}`)
    // } else {
    //   client.logger.info('WSTrackStart', `[DEBUG] No WS connection found for guild: ${player.guildId}`)
    // }
